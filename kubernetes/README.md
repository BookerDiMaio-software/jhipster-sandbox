...
```
$ docker image tag gateway cameronavelisbooker/sandbox-gateway
$ docker push cameronavelisbooker/sandbox-gateway
$ docker image tag microservice1 cameronavelisbooker/sandbox-microservice1
$ docker push cameronavelisbooker/sandbox-microservice1
```
